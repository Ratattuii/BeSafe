...
// Log para debug
console.log('🔄 Iniciando servidor BeSafe...');
...
app.get('/', (req, res) => {
  res.json({
    message: 'BeSafe API - Servidor funcionando!',
    version: '1.0.0',
    endpoints: {
      health: '/health'
    }
...
const server = app.listen(PORT, () => {
  console.log(`🚀 Servidor BeSafe rodando na porta ${PORT}`);
  console.log(`📋 Health check disponível em: http://localhost:${PORT}/health`);
  console.log(`📁 Upload de arquivos configurado em: /uploads`);
...
// Exportar app para testes futuros
module.exports = app;
